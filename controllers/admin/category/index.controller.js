...
module.exports = {
    manageCategory: async function(req, res) {
        ...
        await config.helpers.permission(
            ...
            req,
            (err, permissionData) => {
                res.render("admin/category/view.ejs", {
                ...
                await config.helpers.permission(
                    ...
                    async function(err, permissionData) {
                        for (i = 0; i < data.length; i++) {
                            var arr1 = [];
                            let src =
                                config.constant.CATEGORYTHUMBNAILSHOWPATH +
                            ...
                            if (!data[i].status) {
                                let change_status =
                                    "changeStatus(this,'1','change_status_category','list_category','category');";
                                arr1.push(
                                ...
                                let change_status =
                                    "changeStatus(this,'0','change_status_category','list_category','category');";
                                arr1.push(
                            ...
                            if (permissionData.delete == "1") {
                                let remove =
                                    "deleteData(this,'delete_category','list_category','category');";
                                $but_delete =
                    ...
                    .then(async() => {
                        new Promise(function(resolve1, reject1) {
                            ...
                            new Promise(function(resolve2, reject2) {
                                ...
                                await Category.updateOne({ _id: mongoose.mongo.ObjectId(req.body.id) },
                                    data,
                                    function(err, data) {
                                        if (err) {
                                            console.log(err);
    ...
    deleteCategory: async function(req, res) {
        ...
        let productData = await Product.find({
            categoryId: mongoose.mongo.ObjectId(id),
        });
        ...
        if (subcategoryData.length > 0) {
            ...
            return Category.updateOne({ _id: mongoose.mongo.ObjectId(id) }, { deletedAt: 2 },
                function(err, data) {
